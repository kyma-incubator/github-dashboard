    ...
    <div class="flex flex-wrap -mx-6" v-if="org && org.id">
        ...
        <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
          ...
          <div class="mx-5">
            <h4 class="text-2xl font-semibold text-gray-700">
              {{ org.membersWithRole.totalCount }}
            </h4>
            <div class="text-gray-500">Team Size</div>
          </div>
        </div>
      </div>
      ...
      <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
        <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
          ...
          <div class="mx-5">
            ...
            <div class="text-gray-500">Total Repos</div>
          </div>
        </div>
      </div>
      ...
      <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
        <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
          ...
          <div class="mx-5">
            <h4 class="text-2xl font-semibold text-gray-700">{{getStars(org)}}</h4>
            <div class="text-gray-500">Total Stars</div>
          </div>
        </div>
      </div>
      ...
      <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
        <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
          ...
          <div class="mx-5">
            <h4 class="text-2xl font-semibold text-gray-700">{{getOpenPullRequests(org)}}</h4>
            <div class="text-gray-500">Total open Pull Requests</div>
          </div>
        </div>
      </div>
      ...
      <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
        <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
          ...
          <div class="mx-5">
            <h4 class="text-2xl font-semibold text-gray-700">{{getOpenissues(org)}}</h4>
            <div class="text-gray-500">Totalopen Issues</div>
          </div>
        </div>
      </div>      
    </div>
